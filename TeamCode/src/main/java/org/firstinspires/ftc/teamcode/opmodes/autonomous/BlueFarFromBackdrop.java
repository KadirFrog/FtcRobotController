...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "BlueFarFromBackdrop", group = "!Important")
@SuppressWarnings("ConstantConditions")
public class BlueFarFromBackdrop extends Robot {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        trackPosition.setPosition(new Position(-450.0, 0.0, 0.0));
