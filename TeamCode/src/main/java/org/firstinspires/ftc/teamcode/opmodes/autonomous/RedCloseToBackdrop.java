...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "RedCloseToBackdrop", group = "!Important")
@SuppressWarnings("ConstantConditions")
public class RedCloseToBackdrop extends Robot {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        trackPosition.setPosition(new Position(1800.0, 0.0, 0.0));
